...
50개 질문 기반의 다차원 자존감 분석 시스템으로, 개인화된 피드백과 3단계 이메일 발송을 제공합니다.

## 🎯 주요 기능

### 1. 5차원 분석
- **자존감 안정성**: Contingent vs True Self-Esteem
- **자기 자비**: Self-Criticism vs Self-Compassion  
- **성장 마인드셋**: Fixed vs Growth Mindset
- **관계적 자존감**: Dependent vs Independent
- **암묵적 자존감**: 의식적/무의식적 괴리 분석
