...
2️⃣ 자기 자비: {dimensions['자기_자비']}/10  
   ...
   → Self-Criticism(자기비판) ←→ Self-Compassion(자기자비)
...
3️⃣ 성장 마인드셋: {dimensions['성장_마인드셋']}/10
   ...
   → Fixed Mindset(고정) ←→ Growth Mindset(성장)
...
{format_inline_citation('neff_2003', '목표: 자기비판 → 자기친절')}
...
💡 과학적 근거: {format_inline_citation('gilbert_2009', '자기비판은 위협 시스템을 활성화하지만, 자기친절은 안정 시스템을 활성화합니다')}
...
💡 과학적 근거: {format_inline_citation('dweck_2006', '성장 마인드셋을 가진 사람은 실패를 학습 기회로 봅니다')}

━━━ Week 3: 공통 인간성 인식 ━━━

{format_inline_citation('neff_2003', '목표: "나만 힘들다" → "우리 모두 힘들다"')}
...
💡 과학적 근거: 고립감이 줄어들면 자존감이 자연스럽게 상승합니다 ²

━━━ Week 4: 안정적 자기가치 구축 ━━━

{format_inline_citation('crocker_park_2004', '목표: 조건부 자존감 → 무조건적 자기가치')}
...
💡 과학적 근거: 조건부 자존감은 스트레스와 불안을 높이지만, 
              무조건적 자기가치는 정신건강을 보호합니다 ⁵
